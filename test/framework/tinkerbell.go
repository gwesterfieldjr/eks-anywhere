...
const (
	...
	tinkerbellTemplateUbuntu120EnvVar    = "T_TINKERBELL_TEMPLATE_UBUNTU_1_20"
	tinkerbellTemplateUbuntu121EnvVar    = "T_TINKERBELL_TEMPLATE_UBUNTU_1_21"
...
var requiredTinkerbellEnvVars = []string{
	...
	tinkerbellTemplateUbuntu120EnvVar,
	tinkerbellTemplateUbuntu121EnvVar,
...
func WithUbuntu120Tinkerbell() TinkerbellOpt {
	return func(t *Tinkerbell) {
		t.fillers = append(t.fillers,
			api.WithStringFromEnvVarTinkerbell(tinkerbellTemplateUbuntu120EnvVar, api.WithTemplateForAllTinkerbellMachines),
...
func WithUbuntu121Tinkerbell() TinkerbellOpt {
	return func(t *Tinkerbell) {
		t.fillers = append(t.fillers,
			api.WithStringFromEnvVarTinkerbell(tinkerbellTemplateUbuntu121EnvVar, api.WithTemplateForAllTinkerbellMachines),
			api.WithOsFamilyForAllTinkerbellMachines(anywherev1.Ubuntu),
		)
	}
}
